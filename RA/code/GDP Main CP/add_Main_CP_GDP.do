**************************************************************
*
*		Other Data and Variables to Add to Main-CP: Explorations
*
**************************************************************
...
*********************************************************************
*	Some patents have ID with Letters. When forcing, we drop 2,539,573
*	Citing patents. Hence, we loss forward citations
*	ID SHOULD BE IN STRING, ALWAYS. 
*
*********************************************************************
...
*******************************
*We should merge raw/patent.csv 
*AND THEN we should drop patents without date
******************************
keep if _m==3 
...
*************************************************
*	Merge PDPASS FIRMS and basicbib14 to identify assignees
*	The number of patents deleted from firms is HUGE
*
*******************************************


/*
We should: create a dataset that appends Firm ID from the 3 sources available

*/
***Use firm to identify self-citations 
merge m:1 patent using "$output/firms_CP.dta"
keep if _m==3

*21,002,266 CITING patents deleted!
drop _m
...
merge m:1 patent using "$output/firms_CP.dta"
drop if _m==1 
*10,991,582  CITED patents deleted
drop _m
