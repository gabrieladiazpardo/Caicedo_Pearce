...
* Sept 16, 2020: added code from cr_main_pearce_CP.do 


****************************************
****************************************
* Need to unify it with other files to have an updated version! See add_main_CP and cr_main_pearce_CP
***************************************
****************************************
...
/////////////////////////////////////////
//1. Patents: Application and Grant Year
////////////////////////////////////////

*---Source HARVARD - Disambiguation and Co-authorship Networks of the U.S. Patent Inventor Database:https://dataverse.harvard.edu/file.xhtml?persistentId=doi:10.7910/DVN/5F1RRI/M6Y2OF&version=5.1
...
*3984771 unique patents

*not runned, still original dates_CP
...
*----Source (TEMPORARY - UNTIL 2010) - Harvard: USPTO Patent and Citation Data  (Bhaven Sampat Dataverse)
...
//////////////////////////////////////
//2. Import IPC Classification
/////////////////////////////////////

*-----Source: https://www.patentsview.org/download/
{
...
//////////////////////////////////////
//3. Inventors and Firms
/////////////////////////////////////

*---Source HARVARD - Disambiguation and Co-authorship Networks of the U.S. Patent Inventor
*https://dataverse.harvard.edu/dataset.xhtml?persistentId=hdl:1902.1/15705

*a) Data-set for individuals
{
...
////////////////////////////////////////////////////////////////////////////////////////////
//4. Firms Harmonization (PDPASS FIRMS) - Assignee (Not Used in the construction of main_CP)
///////////////////////////////////////////////////////////////////////////////////////////

*-----Source: USPTO https://www.uspto.gov/web/offices/ac/ido/oeip/taf/data/misc/data_cd.doc/assignee_harmonization/cy2014/
...
*--This data-set is not created in output: Ask Santiago
...
merge m:1 ipc3 using "$wrkdata/patent_ipc3_100"
