...
global figfolder="$main/RA/output/figfolder/harvard-patentsview"
...
global size_font medlarge 

**Other options
global iyear 1975 //initial year of plots
global fyear 2009 //final year of plots
...
use "$datasets/Harvard_pat_lev_dataset.dta", clear
...
twoway (connected  ipc3n appyear if appyear<$fyear, lcolor(navy) lwidth(medthick)) , ///
...
collapse (mean) cit3 cit5 cit8  tprod_cit3 tprod_cit5 tprod_cit8, by(appyear)
