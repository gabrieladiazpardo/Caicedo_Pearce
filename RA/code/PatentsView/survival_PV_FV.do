******************************************************
*		Creation Survival Measures - FINAL VERSION
*
****************************************************

global figfolder="$main/RA/output/figfolder/survival"
global tabfolder="$main/RA/output/tabfolder/survival"
...
drop tot_transitions_inv max_transitions_inv
*/
...
*dnext_pat ------> Dummy if the inventor will have next patent
...
keep patent categ1 ///
Nrep_coinv frac_rep_coinv dpat_rpat_inv ///
mpat_frac_rep_coinv mrpat_frac_rep_coinv  ///
Ncoinv Nd_coinv ///
mfrac_dcoinv mNd_coinv mNcoinv

duplicates drop patent categ1, force

compress

save "$datasets/survival_agg_measure.dta", replace
